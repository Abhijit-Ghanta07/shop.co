    ...
    <section className="py-10 lg:container lg:mx-auto">
      <div className="wrapper  w-[90%] mx-auto rounded-2xl p-10 bg-black ">
        <div className="flex flex-col md:flex-row gap-3 justify-between">
          <h2 className="uppercase font-extrabold whitespace-normal text-active text-2xl text-center text-balance md:text-4xl  basis-1/3">
          ...
          <div className="flex flex-col justify-center items-center gap-2 basis-1/3">
            ...
            <button className="capitalize w-fit sm:w-[18rem] rounded-badge btn bg-light">
