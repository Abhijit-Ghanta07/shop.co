        ...
        <footer className="footer bg-white text-black p-5 sm:p-10">
          <aside>
            <h3 className="w-40 text-ellipsis ">
              <span className="font-extrabold integral text-2xl">
                SHOP.
                <span>CO</span>
              </span>
            </h3>
          ...
          <div className="flex flex-wrap">
            <nav className="flex flex-col px-5 py-2 gap-2">
              <h6 className=" text-dark font-bold my-2 text-lg">Services</h6>
            ...
            <nav className="flex flex-col px-5 py-2 gap-2">
              <h6 className=" text-dark font-bold my-2 text-lg">Company</h6>
            ...
            <nav className="flex flex-col px-5 py-2 gap-2">
              <h6 className=" text-dark font-bold my-2 text-lg">Legal</h6>
